...
const projectData = [
  {
    ...
    description: "An advanced AI-powered system that analyzes industry trends and provides strategic insights for banks. The system offers corporate loan recommendations and enhances digital banking offerings through machine learning algorithms.",
    ...
    technologies: ["Python", "Machine Learning", "RNN", "Data Analysis", "AI/ML"],
    category: "research",
    status: "completed",
  ...
  },
  {
    ...
    description: "A comprehensive employee management system with seamless frontend-backend communication, user-friendly interface, and robust data integrity features.",
    detailedDescription: "A complete employee management solution that streamlines HR operations. Features include employee registration, attendance tracking, performance management, and reporting. Built with modern web technologies ensuring scalability and security.",
    technologies: ["Spring Boot", "MySQL", "React", "Vite.js", "Bootstrap", "Maven", "Spring Data JPA"],
    category: "web",
    status: "completed",
  ...
  },
  {
    ...
    description: "A collaborative task management platform designed to improve team productivity through efficient task assignment, tracking, and review processes.",
    detailedDescription: "EventPluse is a microservices-based task management system that enables seamless collaboration between team members. Admins can create and assign tasks while users can complete and submit them for review, with real-time updates and notifications.",
    technologies: ["Spring Boot (Microservice)", "React.js", "MySQL", "Microservices Architecture"],
    category: "web",
    status: "ongoing",
    role: "Full-Stack Developer",
    githubLink: "#", // Placeholder for GitHub link
  ...
  },
  {
    ...
    description: "A comprehensive workout tracking application with CI/CD pipeline for efficient deployment and continuous integration.",
    detailedDescription: "A modern fitness application that helps users track their workouts, set goals, and monitor progress. Features include workout planning, progress analytics, and social sharing. Implemented with automated deployment pipeline for seamless updates.",
    technologies: ["React.js", "Node.js", "Express.js", "MongoDB", "AWS", "CI/CD"],
    category: "web",
    status: "completed",
    role: "Full-Stack Developer",
    githubLink: "#", // Placeholder for GitHub link
  ...
  },
  {
    ...
    description: "A streamlined system for managing NIC (National Identity Card) submission and dispatching processes to enhance efficiency and user experience.",
    detailedDescription: "Developed a React-based frontend system for the Sri Lankan government's registration department. The system streamlines the queue management process for NIC submissions, reducing wait times and improving overall service efficiency.",
    technologies: ["React.js", "Government Systems", "Queue Management", "User Experience"],
    category: "government",
    status: "completed",
  ...
  },
  {
    ...
    description: "A secure platform for managing and sharing personal health data, reports, and imaging with authorized access control.",
    detailedDescription: "An internship project focused on healthcare data management. The platform enables secure storage, sharing, and access to personal health records, medical reports, and imaging data. Implements strict security protocols for HIPAA compliance.",
    technologies: ["React", "Node.js", "Healthcare Systems", "Data Security", "HIPAA Compliance"],
    category: "healthcare",
    status: "completed",
    role: "Full Stack Developer",
    githubLink: "#", // Placeholder for GitHub link
  ...
  },
  {
    ...
    description: "A responsive web and mobile application for sending SMS to large audiences with advanced features like scheduling and reporting.",
    detailedDescription: "A comprehensive SMS marketing platform designed for businesses with large customer bases. Features include time scheduling, audience segmentation, categorization, and detailed analytics reporting. Supports both web and mobile interfaces.",
  ...
  },
  {
    ...
    description: "An innovative project that translates sign language into normal language displayed on a screen to improve communication for deaf/mute individuals.",
    detailedDescription: "A hardware-software solution that uses sensors and C programming to detect hand gestures and translate them into text. The system helps bridge communication gaps between deaf/mute individuals and others, promoting inclusivity and accessibility.",
    technologies: ["C", "Hardware Integration", "Sensor Technology", "Signal Processing"],
    category: "hardware",
    status: "completed",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {filteredProjects.map((project, index) => (
            ...
            >
              {/* Card Background */}
              <div className={`absolute inset-0 bg-gradient-to-br ${project.color} rounded-xl blur-sm group-hover:blur-md transition-all duration-300 opacity-20`} />
               ...
               <div className="relative bg-black/30 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden h-full hover:border-accent/50 transition-all duration-300">
                ...
                {/* Technologies */}
                <div className="mb-6">
                  <h4 className="text-white/80 text-sm font-semibold mb-3">Technologies Used</h4>
                ...
                <div className="mb-6">
                  <p className="text-white/60 text-xs">
                    <span className="text-accent font-medium">Role:</span> {project.role}
                  </p>
                </div>
        ...
        >
          <div className="bg-gradient-to-r from-accent/10 to-blue-500/10 rounded-xl p-8 border border-accent/20">
            ...
            <p className="text-white/80 mb-6 max-w-[500px] mx-auto">
              Let's work together on your next project. I'm available for freelance work, 
              full-time positions, and exciting collaborations.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
        ...
        >
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-accent font-semibold mb-2">Detailed Description</h3>
                <p className="text-white/80 leading-relaxed">{selectedProject.detailedDescription}</p>
              </div>
